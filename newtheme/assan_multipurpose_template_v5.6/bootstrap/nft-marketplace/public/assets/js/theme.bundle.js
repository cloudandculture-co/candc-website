...
(function () {
  ...
  var showActiveTheme = function showActiveTheme(theme) {
    var suppressInitialIcon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    if (!btnToActive) {
      console.warn("Theme button with value \"".concat(theme, "\" not found"));
      return;
    }
    var iconOfActiveBtn = btnToActive.querySelector('.theme-icon .material-icons');
    if (!iconOfActiveBtn) {
      console.warn("Theme icon not found for \"".concat(theme, "\""));
      return;
    }
    var iconName = iconOfActiveBtn.textContent.trim();
  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    var activeThemeIcon = document.querySelector('.theme-icon-active .material-icons');
    var btnToActive = document.querySelector("[data-bs-theme-value=\"".concat(currentTheme, "\"]"));
